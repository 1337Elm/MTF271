...
xy_hump_fine = np.loadtxt(name_dat + "xy_hump_fine.dat")
x1=xy_hump_fine[:,0]
y1=xy_hump_fine[:,1]
...
# read data file
vectz = np.loadtxt(name_dat + "vectz_fine.dat")
ntstep=vectz[0]
ni=int(vectz[1])
nj=int(vectz[2])
nk=int(vectz[3])
...
plt.savefig('Assignment 2/Assignment 2b/u065_hump_python_eps.png',bbox_inches='tight')
